...
void MainWindow::initMenuConnections()
{
    ...
    connect(m_act_rename_playlist, &QAction::triggered, this,
            &MainWindow::sgnRenamePlaylistRequested);
    connect(m_act_remove_playlist, &QAction::triggered, this,
            &MainWindow::sgnRemovePlaylistRequested);
...
void MainWindow::buildCentralArea()
{
    ...
    m_hbl_centre->addWidget(m_library_panel, 7);
