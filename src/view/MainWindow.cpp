...
PlaylistTreeWidget* MainWindow::playlistTreeWidget() const
{
    return m_playlist_tree_widget;
}

LibraryBrowserWidget* MainWindow::libraryBrowser() const
{
    return m_library_browser;
}

SongTableView* MainWindow::songTableView() const
{
...
void MainWindow::buildCentralArea()
{
    ...
    m_song_table_view->setModel(playlist_controller_->viewModel());
